...
function _parse() {
  _parse = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(text) {
    var questionMatch, answerMatch, choicesMatch, question, choices, answer, parse_group;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          questionMatch = String(text).match(/Question:"?\s*([^"]+)"?/);
          answerMatch = String(text).match(/Answer:"?\s*([^"]+)"?/);
          choicesMatch = _toConsumableArray(String(text).matchAll(/\d+\)\s*"?([^"]+)"?/g));
          question = questionMatch ? questionMatch[1] : null;
          choices = choicesMatch.map(function (match) {
            return match[1];
          });
...
function generate_ui(_x6) {
  return _generate_ui.apply(this, arguments);
}
function _generate_ui() {
  _generate_ui = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
  ...
  _main = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 9:
          system_text = _context5.sent;
          _context5.next = 12;
          return generate_response(system_text, user_text);
        case 12:
          quiz_obj = _context5.sent;
          _context5.next = 15;
...
/******/ 	(() => {
/******/ 		__webpack_require__.h = () => ("1af87158c643c2efb419")
/******/ 	})();
/******/ 	
...
/******/ 		}
/******/ 		
/******/ 		self["webpackHotUpdatepackage"] = (chunkId, moreModules, runtime) => {
